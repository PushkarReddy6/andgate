...
void Vand_gate_tb___024root__trace_chg_sub_0(Vand_gate_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vand_gate_tb___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vand_gate_tb___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vand_gate_tb___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vand_gate_tb___024root__trace_chg_sub_0(Vand_gate_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vand_gate_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vand_gate_tb___024root__trace_chg_sub_0\n"); );
    // Init
