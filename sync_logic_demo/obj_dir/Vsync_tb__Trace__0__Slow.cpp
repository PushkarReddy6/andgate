...
VL_ATTR_COLD void Vsync_tb___024root__trace_full_sub_0(Vsync_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+2,(vlSelf->sync_tb__DOT__async_reset));
    bufp->fullBit(oldp+3,(vlSelf->sync_tb__DOT__async_signal));
    bufp->fullBit(oldp+4,(vlSelf->sync_tb__DOT__synced_reset));
    bufp->fullBit(oldp+5,(vlSelf->sync_tb__DOT__synced_signal));
    bufp->fullBit(oldp+6,(vlSelf->sync_tb__DOT__dut__DOT__u_cdc_sync__DOT__stage1));
    bufp->fullBit(oldp+7,(vlSelf->sync_tb__DOT__dut__DOT__u_reset_sync__DOT__sync_ff1));
}
