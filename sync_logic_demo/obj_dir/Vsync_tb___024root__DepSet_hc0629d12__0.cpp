...
VL_INLINE_OPT VlCoroutine Vsync_tb___024root___eval_initial__TOP__1(Vsync_tb___024root* vlSelf) {
    ...
    while (1U) {
        co_await vlSelf->__VdlySched.delay(5ULL, nullptr, 
                                           "sync_tb.v", 
                                           10);
        vlSelf->sync_tb__DOT__clk = (1U & (~ (IData)(vlSelf->sync_tb__DOT__clk)));
    }
}
...
VL_INLINE_OPT void Vsync_tb___024root___nba_sequent__TOP__0(Vsync_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->sync_tb__DOT__synced_signal = vlSelf->sync_tb__DOT__dut__DOT__u_cdc_sync__DOT__stage1;
    vlSelf->sync_tb__DOT__dut__DOT__u_cdc_sync__DOT__stage1 
        = vlSelf->sync_tb__DOT__async_signal;
}
...
VL_INLINE_OPT void Vsync_tb___024root___nba_sequent__TOP__1(Vsync_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->sync_tb__DOT__synced_reset = ((IData)(vlSelf->sync_tb__DOT__async_reset) 
                                          | (IData)(vlSelf->sync_tb__DOT__dut__DOT__u_reset_sync__DOT__sync_ff1));
    vlSelf->sync_tb__DOT__dut__DOT__u_reset_sync__DOT__sync_ff1 
        = vlSelf->sync_tb__DOT__async_reset;
}
