...
VlCoroutine Vmux4x1_behavioral_tb___024root___eval_initial__TOP__0(Vmux4x1_behavioral_tb___024root* vlSelf);
...
void Vmux4x1_behavioral_tb___024root___eval_initial(Vmux4x1_behavioral_tb___024root* vlSelf) {
    ...
    Vmux4x1_behavioral_tb___024root___eval_initial__TOP__0(vlSelf);
}

VL_INLINE_OPT VlCoroutine Vmux4x1_behavioral_tb___024root___eval_initial__TOP__0(Vmux4x1_behavioral_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmux4x1_behavioral_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux4x1_behavioral_tb___024root___eval_initial__TOP__0\n"); );
    // Body
    VL_WRITEF("BEHAVIORAL 4x1 MUX TEST\n----------------------\nSEL | IN     | OUT\n----------------------\n");
    vlSelf->mux4x1_behavioral_tb__DOT__in = 0xaU;
    vlSelf->mux4x1_behavioral_tb__DOT__sel = 0U;
    co_await vlSelf->__VdlySched.delay(0x2710ULL, nullptr, 
                                       "mux4x1_behavioral_tb.v", 
                                       20);
    VL_WRITEF("%b  | %b |  %b\n",2,vlSelf->mux4x1_behavioral_tb__DOT__sel,
              4,(IData)(vlSelf->mux4x1_behavioral_tb__DOT__in),
              1,vlSelf->mux4x1_behavioral_tb__DOT__out);
    vlSelf->mux4x1_behavioral_tb__DOT__sel = 1U;
    co_await vlSelf->__VdlySched.delay(0x2710ULL, nullptr, 
                                       "mux4x1_behavioral_tb.v", 
                                       21);
    VL_WRITEF("%b  | %b |  %b\n",2,vlSelf->mux4x1_behavioral_tb__DOT__sel,
              4,(IData)(vlSelf->mux4x1_behavioral_tb__DOT__in),
              1,vlSelf->mux4x1_behavioral_tb__DOT__out);
    vlSelf->mux4x1_behavioral_tb__DOT__sel = 2U;
    co_await vlSelf->__VdlySched.delay(0x2710ULL, nullptr, 
                                       "mux4x1_behavioral_tb.v", 
                                       22);
    VL_WRITEF("%b  | %b |  %b\n",2,vlSelf->mux4x1_behavioral_tb__DOT__sel,
              4,(IData)(vlSelf->mux4x1_behavioral_tb__DOT__in),
              1,vlSelf->mux4x1_behavioral_tb__DOT__out);
    vlSelf->mux4x1_behavioral_tb__DOT__sel = 3U;
    co_await vlSelf->__VdlySched.delay(0x2710ULL, nullptr, 
                                       "mux4x1_behavioral_tb.v", 
                                       23);
    VL_WRITEF("%b  | %b |  %b\n",2,vlSelf->mux4x1_behavioral_tb__DOT__sel,
              4,(IData)(vlSelf->mux4x1_behavioral_tb__DOT__in),
              1,vlSelf->mux4x1_behavioral_tb__DOT__out);
    VL_FINISH_MT("mux4x1_behavioral_tb.v", 24, "");
}

extern const VlUnpacked<CData/*0:0*/, 64> Vmux4x1_behavioral_tb__ConstPool__TABLE_h46b9b5e8_0;
...
VL_INLINE_OPT void Vmux4x1_behavioral_tb___024root___act_sequent__TOP__0(Vmux4x1_behavioral_tb___024root* vlSelf) {
    ...
    __Vtableidx1 = 0;
    // Body
    __Vtableidx1 = (((IData)(vlSelf->mux4x1_behavioral_tb__DOT__in) 
                     << 2U) | (IData)(vlSelf->mux4x1_behavioral_tb__DOT__sel));
    vlSelf->mux4x1_behavioral_tb__DOT__out = Vmux4x1_behavioral_tb__ConstPool__TABLE_h46b9b5e8_0
        [__Vtableidx1];
}
